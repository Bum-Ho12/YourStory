                    ...
                    <View style={newMultipleStyle.container}>
                        ...
                        <View style={newMultipleStyle.contentWrapper}>
                            ...
                            <View>
                                ...
                                <TouchableOpacity onPress={toggleTopicModal} style={newMultipleStyle.btnAdd}>
                                    <Ionicons name="md-pricetag-outline" size={24} color={darkTheme ? '#ffffff' : '#121212'} />
                                    <Text style={newMultipleStyle.btnTextAdd}>Select Topic</Text>
                                </TouchableOpacity>
                                {/* Modal to display the topics */}
                                <Modal
                                ...
                                >
                                    <View style={newMultipleStyle.topicModal}>
                                        {/* Close button for the modal */}
                                        <TouchableOpacity onPress={toggleTopicModal} style={newMultipleStyle.btnClose}>
                                            <Ionicons name="md-close" size={24} color={darkTheme ? '#ffffff' : '#121212'} />
                                        </TouchableOpacity>
                                        {/* Search input for topics */}
                                        <TextInput
                                        style={newMultipleStyle.topicSearch}
                                        placeholder="Search Topics"
                                        // Implement a function to handle topic search
                                        onChangeText={(searchText) => console.log(searchText)}
                                        />
                                        {/* List of topics */}
                                        <ScrollView>
                                        {topics.map((topic, index) => (
                                            <TouchableOpacity key={index} onPress={() => console.log('Selected Topic:', topic)}>
                                            <Text style={newMultipleStyle.topicItem}>{topic}</Text>
                                            </TouchableOpacity>
                                        ))}
                                        </ScrollView>
                                    </View>
