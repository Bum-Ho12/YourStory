...
const MyBlogs=({navigation})=>{
    ...
    const fetchStatistics = async()=>{
        await axios.get("https://backend.yetublog.com/statistics/",{
            headers:{
    ...
    const fetchBlogs= async()=>{
        await axios.get("https://backend.yetublog.com/user_blogs/",{
            headers:{
                Authorization: `Token ${token}`,
                // 'Content-Type': 'multipart/form-data'
            },
                            ...
                            <View style={homeStyle.lowerWrapper}>
                                    ...
                                    <View>
                                        <FlatList
                                            ...
                                            renderItem={({ item }) => <BlogCard data={item} navigation={navigation}
                                            />}
