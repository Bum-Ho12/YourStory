...
export const NavigationBarStyle =()=>{
    ...
    const styles = StyleSheet.create({
        ...
        btn:{
            paddingHorizontal:windowWidth>400?10:5,
...
export const BlogContentStyle = ()=>{
    ...
    const styles = StyleSheet.create({
        container:{
            flex:1,
            backgroundColor: darkTheme?'#121212':'#ffffff',
            width: windowWidth>400 ?windowWidth*0.7: windowWidth*0.8
        },
        upperWrapper:{
        ...
        img:{
            width: windowWidth>800?400: 300,
            height: windowWidth>800?350: 200,
            borderRadius: 10,
        },
        contentImg:{
            width: windowWidth>800?700: 300,
...
export const  BottomSideStyle = ()=>{
    ...
    const styles = StyleSheet.create({
        container:{
            backgroundColor: darkTheme?'rgba(0, 0, 0, 0.8)': '#F6FAF8',
            padding: 10,
            paddingBottom: 20,
            width: windowWidth,
            alignItems: 'center',
        ...
        linkWrapper:{
            flexDirection: 'row',
            paddingVertical: 10,
            paddingHorizontal: windowWidth>400?20:5,
        },
        bottomContent:{
            alignItems: 'center',
            flexDirection: 'row'
