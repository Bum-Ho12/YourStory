...
export const HomeStyle  = ()=>{
    ...
    const styles = StyleSheet.create({
        ...
        trendingWrapper:{
            ...
            alignContent: 'space-around',
            alignItems: 'flex-start',
            width: windowWidth>800?windowWidth*0.95:windowWidth,
        },
        topicsWrapper:{
            padding: 10,
            alignItems: 'space-between',
...
export const FormStyle= ()=>{
    ...
    const styles = StyleSheet.create({
        ...
        inputField: {
            ...
            borderRadius: 0,
            borderWidth: 0,
            backgroundColor: darkTheme?'#F0F0F0':'#F0F0F0',
            fontFamily: 'roboto-medium',
...
export const TopicStyle = ()=>{
    ...
    const styles = StyleSheet.create({
        extendedBtn:{
            alignItems: 'center',
            justifyContent:'center',
            backgroundColor: darkTheme?'#ffffff':'#F3F0F0',
            paddingVertical: 5,
            paddingHorizontal: 5,
            flexDirection:'row',
            marginVertical: 5,
        ...
        extendText:{
            color: darkTheme?'#ffffff':'#242424',
            fontSize: windowWidth> 600?14: 12,
            fontWeight: '200',
            fontFamily: 'roboto-regular',
        },
    })
...
export const NewMultipleStyle= ()=>{
    ...
    const styles = StyleSheet.create({
        container:{
            ...
            backgroundColor: darkTheme?'#121212':'#ffffff',
            width: windowWidth,
            height: windowWidth>600 && windowHeight
        },
        contentWrapper:{
            alignContent: 'center',
            alignItems: 'center',
